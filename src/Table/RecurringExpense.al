table 50100 Zyn_RecurringExpenseTable
{
    DataClassification = ToBeClassified;
    fields
    {
        field(1; "Recurring ID"; Integer)
        {
        ...
        field(4; "Cycle"; Enum "Zyn_Recurring Expense Cycle")
        {
            Caption = 'Cycle';
        }
    ...
    procedure CalcNextCycleDate(CurrentDate: Date; Cycle: Enum "Zyn_Recurring Expense Cycle")
    begin
